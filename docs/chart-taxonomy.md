...
| 2 | Categorical Time | 492 | 24.8% | small_multiples / heatmap | Time + medium-cardinality categorical dim (6-50 options) |
...
| 9 | Urban/Rural | 68 | 3.4% | line / small_multiples / horizontal_bar | Residence (urban/rural) splits over time |
...
### 2. Categorical Time (492 datasets)
